...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      "peer h-6 w-6 shrink-0 rounded-[6px] border-2 border-[var(--color-border-strong)] bg-[var(--color-bg-sunken)]",
    ...
    {...props}
  >
    <CheckboxPrimitive.Indicator className="flex items-center justify-center text-[var(--color-text-on-primary)]">
